local strings = {
    ...
    FASTRESET_MENU_SECTION_DEATHDETECTION_SLIDER_BOSSPERCENTAGE_TEXT = "do not reset under %",
    FASTRESET_MENU_SECTION_DEATHDETECTION_SLIDER_BOSSPERCENTAGE_TOOLTIP = "do not reset the trial if the boss is under a specific percentage",
